...
const fetchInvoices = async () => {
  setIsLoading(true);
  try {
    let url = `https://emr-fb-1.onrender.com/api/billing?page=${currentPage}`;
  ...
  const fetchBillingSummary = async () => {
    try {
      const response = await axios.get('https://emr-fb-1.onrender.com/api/billing/summary/dashboard');

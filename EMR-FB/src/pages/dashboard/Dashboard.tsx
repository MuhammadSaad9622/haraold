  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const patientsResponse = await axios.get('https://emr-fb-1.onrender.com/api/patients?limit=1');
        
        // Fetch today's appointments
        const todayAppointmentsResponse = await axios.get(`https://emr-fb-1.onrender.com/api/appointments?startDate=${today}&endDate=${tomorrow}`);
        
        // Fetch upcoming appointments
        const upcomingAppointmentsResponse = await axios.get(`https://emr-fb-1.onrender.com/api/appointments?startDate=${tomorrow}&endDate=${nextWeek}`);
        
        // Fetch billing summary
        const billingSummaryResponse = await axios.get('https://emr-fb-1.onrender.com/api/billing/summary/dashboard');
        
        // Fetch recent appointments
        const recentAppointmentsResponse = await axios.get('https://emr-fb-1.onrender.com/api/appointments?limit=5');
